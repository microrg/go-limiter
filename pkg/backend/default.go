...
func makeHttpRequest(url string, apiToken string, payload map[string]string) (*http.Response, error) {
...
func (b *DefaultBackend) Increment(featureID string, userID string) error {
	payload := map[string]string{"project_id": b.ProjectID, "feature_id": featureID, "user_id": userID}
...
func (b *DefaultBackend) Decrement(featureID string, userID string) error {
	payload := map[string]string{"project_id": b.ProjectID, "feature_id": featureID, "user_id": userID}
...
func (b *DefaultBackend) Set(featureID string, userID string, value int) error {
	payload := map[string]string{"project_id": b.ProjectID, "feature_id": featureID, "user_id": userID, "value": strconv.Itoa(value)}
...
func (b *DefaultBackend) FeatureMatrix() (*FeatureMatrix, error) {
	payload := map[string]string{"project_id": b.ProjectID}
...
func (b *DefaultBackend) Usage(userID string) (*FeatureUsage, error) {
	payload := map[string]string{"project_id": b.ProjectID, "user_id": userID}
